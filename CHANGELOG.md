...
- establish the SpatialSHAP package contract;
- add global, kernel, and nearest-neighbour reference distributions;
- add exact spatially conditioned Shapley calculation for single-output models;
- add immutable `SpatialExplanation` results and tabular exports;
- add an exact grouped GEO reference-switch game;
- add feature primary, GEO main, and GEO–feature interaction decomposition;
